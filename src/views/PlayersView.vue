  ...
  <div class="mx-auto max-w-3xl space-y-10 pb-20">
      ...
      <transition-group name="list" tag="ul" class="grid gap-2">
        ...
        >
          ...
          <div class="flex gap-1">
            ...
            <button type="button" class="p-2 text-slate-700 transition-colors hover:text-red-500" @click="removePlayer(p.id)">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section v-if="libraryOptions.length > 0" class="border-t border-slate-900 pt-6">
      ...
      <button
        ...
        type="button"
        class="mt-6 w-full rounded-xl bg-slate-100 py-3 text-xs font-black uppercase italic tracking-widest text-black hover:bg-white"
