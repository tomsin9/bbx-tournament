...
<template>
  <div class="mx-auto max-w-3xl space-y-8 pb-32">
    ...
    <section v-else class="pb-10">
      <PlayerManagerPanel
        :use-draft="isNewSetup"
        :draft-players="draftPlayers"
        :max-beys-per-player="maxBeysPerPlayer"
        :roster-title="t('setup.currentRoster')"
        :empty-hint-text="isNewSetup ? t('setup.emptyPlayersHint') : t('players.noPlayersReady')"
        @update:draft-players="updateDraftPlayers"
      />
    </section>
